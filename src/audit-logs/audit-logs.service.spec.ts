...
describe('AuditLogsService', () => {
  ...
  it('aggregates item CRUD audit logs in the frontend report shape', async () => {
    aggregateExec.mockResolvedValue([
      {
        data: [
          {
            _id: 'log-4',
            timestamp: new Date('2026-07-17T10:25:00.000Z'),
            createdAt: new Date('2026-07-17T10:25:00.000Z'),
            method: 'PATCH',
            path: '/items/item-4',
            statusCode: 200,
            action: 'updated',
    ...
    const result = await service.findItemCrudLogs({
      page: '1',
      limit: '1000',
      storeId: 'store-1',
      itemId: 'item-4',
